...
if __name__ == '__main__':
    ...
    output = open('/n/seasfs03/IACS/TSC/ncastro/Resultados/EROS/Tree/Completed/Arboles/Arbol_' + percentage + '.pkl', 'wb+')
    pickle.dump(clf, output)
    output.close()

    result.to_csv('/n/seasfs03/IACS/TSC/ncastro/Resultados/EROS/Tree/Completed/Predicciones/result_' + percentage + '.csv')
