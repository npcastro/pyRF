...
if __name__ == '__main__':
    ...
    output = open('/n/seasfs03/IACS/TSC/ncastro/Resultados/EROS/UTree/GP/Arboles/Arbol GP_' + percentage + '.pkl', 'wb+')
    pickle.dump(clf, output)
    output.close()

    result.to_csv('/n/seasfs03/IACS/TSC/ncastro/Resultados/EROS/UTree/GP/Predicciones/result_' + percentage + '.csv')
